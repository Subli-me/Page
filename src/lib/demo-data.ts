...
export const DEMO_SETTINGS: SiteSettings = {
  ...
  hero_secondary_cta_label: "Ver prendas",
  steps_title: "Cómo funciona",
  catalog_title: "Catálogo",
  designs_title: "Catálogo de diseños",
  designs_subtitle: "Elegí uno de nuestros diseños o subí el tuyo propio al hacer tu pedido.",
  designs_cta_label: "Hacer pedido",
  filter_color_label: "Filtrar por color",
  filter_category_label: "Filtrar por categoría",
  designs_more_label: "Ver más diseños",
  product_cta_label: "Elegir",
  works_title: "Trabajos hechos",
  works_subtitle: "Prendas que ya entregamos. Así quedan de verdad, fuera de la pantalla.",
